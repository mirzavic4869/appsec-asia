import { webAttacksData } from '@/components/lib'
import React from 'react'

export default function WebAttacks() {
  return (
    <div className="px-4 py-12 md:px-16 lg:px-20 bg-contact">
      <div className="mx-auto max-w-7xl">
        {/* Description */}
        <h2 className="mb-8 text-2xl font-bold md:text-3xl">
          List of Web Application Attacks and Tests Performed During Penetration
          Testing
        </h2>
            ...
            <div class="inline-block min-w-full py-2 sm:px-6 lg:px-8">
              <div class="overflow-hidden">
                <table className="min-w-full text-sm font-light text-left text-surface">
                  ...
                  <tbody>
                    {webAttacksData.map(({ category, test }, index) => (
                      <tr
